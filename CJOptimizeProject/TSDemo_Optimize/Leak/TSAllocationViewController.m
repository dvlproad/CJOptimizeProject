...
@interface TSAllocationViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation TSAllocationViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = NSLocalizedString(@"模拟内存Allocation", nil);
